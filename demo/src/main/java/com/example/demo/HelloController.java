...
public class HelloController implements Server{
    ...
    public void toAddClock(){
       ...
       if(Type.getText().equals("HM")){shop.add(new Clock(Mark.getText(),Integer.parseInt(Cost.getText()),0,0,k));k++;}
       if(Type.getText().equals("HMS")){shop.add(new Clock2(Mark.getText(),Integer.parseInt(Cost.getText()),0,0,0,k));k++;}
    }
    @FXML
        ...
        if(file!=null){
            ...
            try{
                ...
                Gson gson = new GsonBuilder()
                        .setPrettyPrinting()
                       .registerTypeAdapter(Clock2.class, new Clock2Adapter())
    ...
    public void toLoadJSON(){
        ...
        if(file!=null){
            ...
            catch(IOException ex){System.out.println("ошибка чтения тип 1");}
